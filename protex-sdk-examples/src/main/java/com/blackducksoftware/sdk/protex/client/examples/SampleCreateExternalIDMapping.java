...
import com.blackducksoftware.sdk.protex.policy.externalid.ComponentObjectKey;
 ...
 */
public class SampleCreateExternalIDMapping extends BDProtexSample {
    ...
    private static void usage() {
        String className = SampleCreateExternalIDMapping.class.getSimpleName();

        List<String> parameters = new ArrayList<String>(getDefaultUsageParameters());
        parameters.add("<namespace>");
        parameters.add("<protex object type>");
        ...
        paramDescriptions.add(formatUsageDetail("protex object type", "The type of the protex object to be mapped, \"project\" or \"component\""));
        paramDescriptions.add(formatUsageDetail("protex object ID", "The ID of the protex project or component to map, i.e. \"c_greatapp11_5123\""));
    ...
    public static void main(String[] args) throws Exception {
        ...
        String protexObjectType = args[4];
        String protexObjectId = args[5];
        ...
        try {
            ...
            try {
                ...
                mapping.setProtexObjectKey(createProtexObjectKey(
                        protexObjectType, protexObjectId));
    ...
    private static ProtexObjectKey createProtexObjectKey(String type, String id) {
        ProtexObjectKey protexObjectKey = null;
        for (ProtexObjectType t : ProtexObjectType.values()) {
            if (t.toString().equalsIgnoreCase(type)) {
                switch (t) {
                case COMPONENT:
                    protexObjectKey = new ComponentObjectKey();
                    break;
                case PROJECT:
                    protexObjectKey = new ProjectObjectKey();
                    break;
                default:
                    throw new RuntimeException("Protex object type \"" + type + "\"");
                }
                protexObjectKey.setObjectType(t);
