...
/**
 * This sample creates a user and adds roles to the user
 * 
 * It demonstrates:
 * - How to create a user
 * - How to add role assignments to a user
 */
public class SampleCreateUserWithRoles extends BDProtexSample {
    ...
    private static void usage() {
        String className = SampleCreateUserWithRoles.class.getSimpleName();
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            try {
                ...
                roleApi = myProtexServer.getRoleApi();
            ...
            // These IDs can be retrieved from RoleApi.getUserRoles()
            List<String> rolesToAssign = Arrays.asList("basicdeveloper", "powerdeveloper", "projectleader");

            try {
                roleApi.addUserRoles(userId, rolesToAssign);
                System.out.println("Added roles to user: " + userId);
            } catch (SdkFault e) {
                System.err.println("addUserRoles() failed: " + e.getMessage());
                throw new RuntimeException(e);
            }
