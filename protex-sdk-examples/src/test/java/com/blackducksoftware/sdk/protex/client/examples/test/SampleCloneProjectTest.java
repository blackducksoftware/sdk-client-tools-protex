...
import com.blackducksoftware.sdk.protex.client.examples.SampleCloneProject;
...
public class SampleCloneProjectTest extends AbstractSdkSampleTest {
    ...
    protected void deleteProject() throws Exception {
        if (projectId != null) {
            ...
            // Delete clone
            Project clone = getProxy().getProjectApi().getProjectByName("Copy of " + projectName);
            getProxy().getProjectApi().deleteProject(clone.getProjectId());
        }
    }
